...
M.link.default = {
    ...
    custom = {
        ...
        discord = { pattern = 'discord%.com', icon = '[discord] ' },
        github = { pattern = 'github%.com', icon = '[github] ' },
        gitlab = { pattern = 'gitlab%.com', icon = '[gitlab] ' },
        google = { pattern = 'google%.com', icon = '[google] ' },
        hackernews = { pattern = 'ycombinator%.com', icon = '[hn] ' },
        linkedin = { pattern = 'linkedin%.com', icon = '[linkedin] ' },
        microsoft = { pattern = 'microsoft%.com', icon = '[microsoft] ' },
        neovim = { pattern = 'neovim%.io', icon = '[neovim] ' },
        reddit = { pattern = 'reddit%.com', icon = '[reddit] ' },
        slack = { pattern = 'slack%.com', icon = '[slack] ' },
        stackoverflow = { pattern = 'stackoverflow%.com', icon = '[so] ' },
        steam = { pattern = 'steampowered%.com', icon = '[steam] ' },
        twitter = { pattern = 'x%.com', icon = '[x] ' },
        wikipedia = { pattern = 'wikipedia%.org', icon = '[wikipedia] ' },
        youtube = { pattern = 'youtube%.com', icon = '[youtube] ' },
    },
}
