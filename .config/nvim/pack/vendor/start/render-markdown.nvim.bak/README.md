...
To override highlights after the plugin sets them, listen for the `User RenderMarkdownColors`
event. For example, to force a code block background color:

```lua
vim.api.nvim_create_autocmd('User', {
    pattern = 'RenderMarkdownColors',
    callback = function()
        vim.api.nvim_set_hl(0, 'RenderMarkdownCode', { bg = '#2a2e36' })
    end,
})
```
...
require('render-markdown').setup({
    ...
    code = {
        ...
        -- Turn on / off sign column related rendering.
        sign = true,
        -- Identifier to show in sign column for code blocks, overrides language icon when set.
        -- Output is evaluated depending on the type.
    ...
    callout = {
        ...
        note      = { raw = '[!NOTE]',      rendered = '[i] Note',      highlight = 'RenderMarkdownInfo',    category = 'github'   },
        tip       = { raw = '[!TIP]',       rendered = '[tip] Tip',       highlight = 'RenderMarkdownSuccess', category = 'github'   },
        important = { raw = '[!IMPORTANT]', rendered = '[!] Important', highlight = 'RenderMarkdownHint',    category = 'github'   },
        warning   = { raw = '[!WARNING]',   rendered = '[warn] Warning',   highlight = 'RenderMarkdownWarn',    category = 'github'   },
        caution   = { raw = '[!CAUTION]',   rendered = '[caution] Caution',   highlight = 'RenderMarkdownError',   category = 'github'   },
        -- Obsidian: https://help.obsidian.md/Editing+and+formatting/Callouts
        abstract  = { raw = '[!ABSTRACT]',  rendered = '[sum] Abstract',  highlight = 'RenderMarkdownInfo',    category = 'obsidian' },
        summary   = { raw = '[!SUMMARY]',   rendered = '[sum] Summary',   highlight = 'RenderMarkdownInfo',    category = 'obsidian' },
        tldr      = { raw = '[!TLDR]',      rendered = '[sum] Tldr',      highlight = 'RenderMarkdownInfo',    category = 'obsidian' },
        info      = { raw = '[!INFO]',      rendered = '[i] Info',      highlight = 'RenderMarkdownInfo',    category = 'obsidian' },
        todo      = { raw = '[!TODO]',      rendered = '[todo] Todo',      highlight = 'RenderMarkdownInfo',    category = 'obsidian' },
        hint      = { raw = '[!HINT]',      rendered = '[tip] Hint',      highlight = 'RenderMarkdownSuccess', category = 'obsidian' },
        success   = { raw = '[!SUCCESS]',   rendered = '[ok] Success',   highlight = 'RenderMarkdownSuccess', category = 'obsidian' },
        check     = { raw = '[!CHECK]',     rendered = '[ok] Check',     highlight = 'RenderMarkdownSuccess', category = 'obsidian' },
        done      = { raw = '[!DONE]',      rendered = '[ok] Done',      highlight = 'RenderMarkdownSuccess', category = 'obsidian' },
        ...
        attention = { raw = '[!ATTENTION]', rendered = '[warn] Attention', highlight = 'RenderMarkdownWarn',    category = 'obsidian' },
        failure   = { raw = '[!FAILURE]',   rendered = '[x] Failure',   highlight = 'RenderMarkdownError',   category = 'obsidian' },
        fail      = { raw = '[!FAIL]',      rendered = '[x] Fail',      highlight = 'RenderMarkdownError',   category = 'obsidian' },
        missing   = { raw = '[!MISSING]',   rendered = '[x] Missing',   highlight = 'RenderMarkdownError',   category = 'obsidian' },
        ...
        bug       = { raw = '[!BUG]',       rendered = '[bug] Bug',       highlight = 'RenderMarkdownError',   category = 'obsidian' },
        example   = { raw = '[!EXAMPLE]',   rendered = '[ex] Example',   highlight = 'RenderMarkdownHint' ,   category = 'obsidian' },
        quote     = { raw = '[!QUOTE]',     rendered = '[quote] Quote',     highlight = 'RenderMarkdownQuote',   category = 'obsidian' },
        cite      = { raw = '[!CITE]',      rendered = '[quote] Cite',      highlight = 'RenderMarkdownQuote',   category = 'obsidian' },
    },
    link = {
        ...
        custom = {
            web = { pattern = '^http', icon = '[web] ' },
            apple = { pattern = 'apple%.com', icon = '[apple] ' },
            discord = { pattern = 'discord%.com', icon = '[disc] ' },
            github = { pattern = 'github%.com', icon = '[gh] ' },
            gitlab = { pattern = 'gitlab%.com', icon = '[gl] ' },
            google = { pattern = 'google%.com', icon = '[goog] ' },
            hackernews = { pattern = 'ycombinator%.com', icon = '[hn] ' },
            linkedin = { pattern = 'linkedin%.com', icon = '[in] ' },
            microsoft = { pattern = 'microsoft%.com', icon = '[ms] ' },
            neovim = { pattern = 'neovim%.io', icon = '[nvim] ' },
            reddit = { pattern = 'reddit%.com', icon = '[rdt] ' },
            slack = { pattern = 'slack%.com', icon = '[slack] ' },
            stackoverflow = { pattern = 'stackoverflow%.com', icon = '[so] ' },
            steam = { pattern = 'steampowered%.com', icon = '[stm] ' },
            twitter = { pattern = 'x%.com', icon = '[tw] ' },
            wikipedia = { pattern = 'wikipedia%.org', icon = '[wp] ' },
            youtube = { pattern = 'youtube%.com', icon = '[yt] ' },
        },
    },
    sign = {
