...
describe('ad hoc', function()
    ...
    it('image', function()
        ...
        util.assert_view(marks, { '[img] test' })
    end)
    ...
    it('wikilink', function()
        ...
        util.assert_view(marks, { '[wiki] Basic One Then normal text' })
    end)
    ...
    it('wikilink with alias', function()
        ...
        util.assert_view(marks, { '[wiki] With Alias Something important' })
    end)
    ...
    it('wikilink media', function()
        ...
        marks:add({ 0, 0 }, { 11, 13 }, util.conceal())
        util.assert_view(marks, { '[wiki] test.png' })
    end)
    ...
    it('email', function()
        ...
        util.assert_view(marks, { '[@] test@example.com Email' })
    end)
    ...
    it('bare url', function()
        ...
        util.assert_view(marks, { '[gh] http://www.github.com/ Bare URL' })
    end)
    ...
    it('youtube', function()
        ...
        util.assert_view(marks, { '[yt] Youtube Link' })
    end)
